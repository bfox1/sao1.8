...
public class ForgeStation extends BlockContainer {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, int eventID, int eventParam) {
	...
	public int getComparatorInputOverride(World world, BlockPos pos, int i) {
